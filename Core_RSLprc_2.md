...
используются при создании макромодулей CurrInter, FIInter, GateInter, InsCarryDoc,
OprInter, PcRateInter, PTInter, RsbDataSet, RsbObjFactory, RsSysLog, SFInter, входящих в
АС RS-Core V.6 ИБС RS-Bank V.6, и при написании пользователем собственных
...
Bank V.6.
Процедуры
Процедуры определения сумм на валютном
лицевом счете
В этом разделе перечислены процедуры, определяющие величину сумм и оборотов
валютных лицевых счетов.
